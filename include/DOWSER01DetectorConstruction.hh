...
// $Id$
//
/// \file DOWSER01DetectorConstruction.hh
/// \brief Definition of the DOWSER01DetectorConstruction class

#ifndef DOWSER01DetectorConstruction_h
#define DOWSER01DetectorConstruction_h 1
...
class DOWSER01DetectorConstruction : public G4VUserDetectorConstruction
{
  public:
    DOWSER01DetectorConstruction();
    virtual ~DOWSER01DetectorConstruction();
